...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('system_settings')->insert([
            ...
            ['group_key' => 'timings', 'key' => 'timings.order_pending_hours', 'label' => 'Часы ожидания заказа в статусе «Новый»', 'value' => '24', 'value_type' => 'integer', 'description' => 'По истечении периода система может напоминать ответственным.', 'sort_order' => 1, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
