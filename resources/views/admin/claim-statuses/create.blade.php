@extends('layouts.app')
@section('title', 'Новый статус претензии')
@section('heading', 'Новый статус претензии')
@section('content')
...
<div class="bg-white dark:bg-gray-800 rounded-xl border p-6"><form method="POST" action="{{ route('admin.claim-statuses.store') }}" class="space-y-5">@csrf @include('admin.partials.status_record_form')
