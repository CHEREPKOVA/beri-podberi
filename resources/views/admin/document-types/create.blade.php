@extends('layouts.app')
@section('title', 'Новый тип документа')
@section('heading', 'Новый тип документа')
@section('content')
...
<div class="bg-white dark:bg-gray-800 rounded-xl border p-6"><form method="POST" action="{{ route('admin.document-types.store') }}" class="space-y-5">@csrf @include('admin.document-types._form', ['contextLabels' => $contextLabels])
