...
@section('title', 'Новая транспортная компания')
@section('heading', 'Новая транспортная компания')
...
<div class="max-w-xl space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        <form method="POST" action="{{ route('admin.transport-companies.store') }}" class="space-y-5">
            @csrf
            @include('admin.transport-companies._form')
