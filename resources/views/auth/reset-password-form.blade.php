    ...
    <div class="relative flex min-h-screen w-full flex-col lg:flex-row">
        <div class="flex w-full flex-1 flex-col lg:w-1/2">
            <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center px-6 pb-10">
                ...
                <div class="mt-8">
                    <h1 class="mb-2 text-xl font-semibold text-gray-800">Новый пароль</h1>
                    ...
                    <form method="POST" action="{{ url('/reset-password') }}">
                        ...
                        <div class="space-y-5">
                            <div>
                                <label for="email_display" class="mb-1.5 block text-sm font-medium text-gray-700">Email</label>
