        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex flex-col xl:flex-row xl:items-start xl:justify-between gap-4">
                <form method="GET" class="flex flex-wrap items-center gap-3 flex-1">
                    ...
                    @if(request()->hasAny(['search','category','brand','status','has_stock','price_min','price_max','updated_from','updated_to']))
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Артикулы</th>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Закуп.</th>
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Отпуск.</th>
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Остаток</th>
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Статус</th>
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Обновлён</th>
