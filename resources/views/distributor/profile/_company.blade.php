<div x-data="{ editing: false }">
    ...
    <form method="POST" action="{{ route('distributor.profile.company.update') }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        >
                            @foreach(\App\Models\DistributorProfile::legalFormLabels() as $value => $label)
