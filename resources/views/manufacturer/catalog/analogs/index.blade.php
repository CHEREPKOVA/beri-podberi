...
@section('heading', 'Аналоги в моем каталоге')

@section('content')
<div class="space-y-6">
    @include('admin.partials.flash')
    <a href="{{ route('manufacturer.catalog.index') }}" class="text-sm text-gray-500 hover:text-[#c3242a]">← Каталог</a>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 text-sm text-gray-500">{{ (int) $product->analogs_count + (int) $product->analog_of_count }}</td>
                        <td class="px-4 py-3 text-right"><a href="{{ route('manufacturer.catalog.analogs.edit', $product) }}" class="text-sm text-[#c3242a] hover:underline">Управлять</a></td>
                    </tr>
                    @empty
